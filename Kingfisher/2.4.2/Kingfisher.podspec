#
#  Be sure to run `pod spec lint Kingfisher.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Kingfisher"
  s.version      = "2.4.2"
  s.summary      = "A lightweight and pure Swift implemented library for downloading and caching image from the web."
  ...
  s.homepage     = "https://github.com/walkdianzi/Kingfisher"
  ...
  s.source       = { :git => "https://github.com/walkdianzi/Kingfisher.git", :tag => s.version }
